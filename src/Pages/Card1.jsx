    ...
    <div className="bg-white pt-[70px] text-black font-roboto">
      ...
      <section className="relative">
        <img
          ...
          style={{ height: '489px' }}
        />
        <div className="absolute top-1/2 w-[370px] sm:w-auto left-1/2 transform -translate-x-1/2 -translate-y-1/2 px-4 text-center">
          <h2
          ...
          >
            Faith-Based Therapy for Anxiety, Stress & Inner Healing
          </h2>
          <p
            className="text-white font-medium text-sm sm:text-base mt-2 max-w-md mx-auto"
            style={{ textShadow: '0px 2px 4px rgba(0,0,0,0.6)' }}
          >
            Discover Peace, Purpose, and God’s Truth Through Christ-Centered Counseling.
          </p>
      ...
      <section className="bg-gray-50 py-12 px-4 md:px-10">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-10 items-start">
          ...
          <div className="lg:w-1/2 space-y-4">
            ...
            <h2 className="text-3xl font-bold leading-tight">A Faith-Based Path Toward Wholeness</h2>
            <p className="text-base text-gray-700">
              Through biblical wisdom and proven techniques, Ellie helps you overcome inner struggles
              and reconnect with your true identity in Christ.
            </p>
            <img
              src="/R1.jpeg"
