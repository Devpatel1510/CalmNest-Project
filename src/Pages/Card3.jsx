...
const Card3 = () => {
      ...
      <section className="relative">
        ...
        <div className="absolute top-1/2 left-1/2 w-[370px] sm:w-auto transform -translate-x-1/2 -translate-y-1/2 px-4 text-center">
         <h2
          ...
          >
            Healing From Within: The Path to Trauma Recovery
          </h2>
          <p
            className="text-white font-medium text-sm sm:text-base mt-2 max-w-md mx-auto"
            style={{ textShadow: '0px 2px 4px rgba(0,0,0,0.6)' }}
          >
            Compassionate, faith-based support to help you process pain, restore hope, and reclaim your life in Christ.
          </p>
  ...
  <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-10 items-start">
    ...
    <div className="lg:w-1/2 space-y-4">
      ...
      <h2 className="text-3xl font-bold leading-tight">A Faith-Based Path to Healing and Renewal</h2>
      <p className="text-base text-gray-700">
       Through biblical wisdom and evidence-based practices, Ellie walks with you through the journey of trauma recovery—helping you find peace, rebuild trust, and rediscover your identity in Christ.
      </p>
      <img
        src="/R5.png"
